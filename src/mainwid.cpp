...
bool MainWid::ConnectSignalSlots()
{
    ...
    connect(ui->CtrlBarWid, &CtrlBar::SigAdjustSpeed, VideoCtl::GetInstance(), &VideoCtl::OnAdjustSpeed);//videoctl.cpp 1834
    ...
    connect(VideoCtl::GetInstance(), &VideoCtl::SigPlaySpeed, ui->CtrlBarWid, &CtrlBar::OnPlaySpeed);
